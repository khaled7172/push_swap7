...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/29 20:14:54 by kali              #+#    #+#             */
/*   Updated: 2026/01/29 20:16:49 by kali             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int calculate_cost_a(int target_pos, int size_a)
{
...
static int calculate_cost_b(int pos_b, int size_b)
{
    if (pos_b <= size_b / 2)
        return (pos_b);
    else
...
static int calculate_total_cost(t_node *a, t_node *b, int pos_b)
{
    t_node  *b_current;
    int     target_pos;
    int     cost_a;
...
// // Option 2: Use Turkish (rename function)
// // In sort_complex_turkish.c, change function name:
// void sort_complex(t_node **a, t_node **b)
// {
//     sort_turkish(a, b);
// }
